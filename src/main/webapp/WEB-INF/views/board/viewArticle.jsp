	...
	<form name="frmArticle" method="post" enctype="multipart/form-data">
		...
		<table border="0" align="center">
			<tr>
				...
				<td align="left"><input  type="text" value="${article.articleNO }" disabled />
					<input type="hidden" name="parentNO" value="${article.articleNO}" />
					<!-- 추후 글 수정시 글 번호 필요함 --></td>
			</tr>

			<tr>
				<td width="150" align="center" bgcolor="#FF9933">작성자 아이디</td>
				<td align="left"><input type="text" value="${article.id }" name="id"
					disabled /></td>
			</tr>
			...
			<tr>
				...
				<td align="left"><textarea rows="10" cols="60" name="content" id="i_content"
		 ...
		 <c:if test="${not empty article.imageFileName && article.imageFileName != 'null' }"> 
			...
			<tr>
				...
				<%-- <td><input type=text value="<fmt:formatDate value=" ${article.writeDate}" />"
									disabled /> --%>
				<td align="left"><input type=text value="${article.writeDate}" disabled />
				</td>
			</tr>
